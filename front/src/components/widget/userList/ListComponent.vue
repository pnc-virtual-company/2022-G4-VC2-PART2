...
>>>>>>> 935d108ad1207aedb3ded64692c495019df14e21
  ...
  >
    ...
    <div class="flex justify-start items-center mb-2">
      <Base_Button
        class="h-10 bg-[#018ABD] py-[6px] flex justify-start"
        @click="addUser"
      >
        <i class="mx-1">
          <svg
    ...
    >
      <div class="form-container rounded w-11/12">
        <Bass_Dialog_Form
          class="z-50"
          @cancel="onCancelCreated"
          @close="openDialogs"
          :object="object"
          @create_student="emitPage"
          :updateValue="objectUpdating"
        ></Bass_Dialog_Form>
      </div>
    </div>
...
>>>>>>> 935d108ad1207aedb3ded64692c495019df14e21
      <thead
        class="
          ...
          uppercase
          bg-slate-300
          dark:bg-gray-50 dark:text-gray-400
        "
      >
...
>>>>>>> 935d108ad1207aedb3ded64692c495019df14e21
          ...
          <!-- Teacher email -->
          <td
            class="py-3 px-4 text-center text-orange-300"
            v-if="standingPage == 'student'"
          >
            {{ item.student[0].year }}
          </td>
          <td
            class="py-3 px-4 text-center text-blue-300"
            v-if="standingPage == 'student'"
          >
          ...
          <td class="w-11/12 flex items-center justify-end mt-2">
            ...
            >
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="w-4 h-4 mx-1 text-blue-500 cursor-pointe"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <i
              class="
                ...
                hover:text-gray-600
              "
              v-if="standingPage != 'follow'"
              @click="$emit('delete_id', item.id)"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
