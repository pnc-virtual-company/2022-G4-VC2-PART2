<template>
  ...
  <div @click="hideRightClik()" class="flex flex-col justify-between overflow-y-auto" style="overflow: scroll;margin-top: 1px; background-color: #DDE8F0; height: 70vh; overflow-x: hidden;">
          ...
          <div class="flex justify-start mb-4 cursor-pointer"   >
            <div class="flex justify-center items-end" >
              ...
              <div @click="hideShow(comment.id)" @contextmenu.capture.prevent="showAction(comment.id)"
                class="ml-1 p-2 max-w-sm bg-white rounded-br-3xl rounded-tr-3xl rounded-tl-xl  text-black  text-start" style="max-width: 460px;  word-break: break-all;  ">
        ...
        <div class="w-full  flex items-end" style="height:100%">
              <div class="w-full">
                <Base_DropDwon_Menu  :title="'Topic'" :lists="lists" @emtt_selecte="getSeleted"  />
                <div class="flex">
