    ...
    <div class="bg-white w-full sm:max-w-7xl md:w-1/3 h-auto shadow px-3 py-2 flex flex-col space-y-2">
      ...
      <div class="flex items-center space-x-2">
        <div class="group relative flex flex-shrink-0 self-start cursor-pointer">
          <img x-on:mouseover="open1 = true" x-on:mouseleave="open1 = false"
          ...
          <div x-cloak x-show.transition.origin.bottom="open1" x-on:mouseover="open1 = true"
            x-on:mouseleave="open1 = false"
            class="absolute mt-8 bg-white px-4 py-4 w-72 shadow rounded cursor-default z-10">
            <div class="flex space-x-3">
              <div class="flex flex-shrink-0">
                <img
                  src="https://images.unsplash.com/photo-1507965613665-5fbb4cbb8399?ixid=MXwxMjA3fDB8MHx0b3BpYy1mZWVkfDQzfHRvd0paRnNrcEdnfHxlbnwwfHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
                  alt="" class="h-16 w-16 object-fill rounded-full">
              </div>
              <div class="flex flex-col space-y-2">
                ...
                <div class="flex justify-start items-center space-x-2">
                  <div>
                    <svg class="w-4 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path
            ...
            <div class="flex space-x-1 mt-2">
              <div class="w-1/2">
                <a href="#"
                  class="text-xs text-blue-600 hover:bg-opacity-60 font-semibold flex items-center justify-center px-3 py-2 bg-blue-300 bg-opacity-50 rounded-lg">
                  <div class="mr-1">
              ...
              <div class="w-auto">
                <a href="#"
                  ...
                  <div class="mr-1">
                    <svg viewBox="0 0 28 28" alt="" class="h-4 w-4" height="20" width="20">
                      <path
          ...
          <div class="block">
            ...
            <div class="flex items-center space-x-2 space-y-2">
              <div class="group relative flex flex-shrink-0 self-start cursor-pointer pt-2">
                <img x-on:mouseover="open2 = true" x-on:mouseleave="open2 = false"
                  ...
                  alt="" class="h-8 w-8 object-fill rounded-full">
                <div x-cloak x-show.transition.origin.bottom="open2" x-on:mouseover="open2 = true"
                  ...
                  <div class="flex space-x-3">
                    ...
                    <div class="flex flex-col space-y-2">
                      ...
                      <div class="flex justify-start items-center space-x-2">
                        <div>
                          <svg class="w-4 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                              d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z">
                            </path>
                        ...
                        <div class="w-auto text-sm leading-none">
                          <small>
                            347 mutual friends including: <a href="#" class="font-semibold hover:underline">Ujang</a>
                            and <a href="#" class="font-semibold hover:underline">Maman</a>
                          </small>
                        </div>
                      </div>
                      <div class="flex justify-start items-center space-x-2">
      ...
      <div class="flex items-center space-x-2">
        <div class="flex flex-shrink-0 self-start cursor-pointer">
          <img
            ...
            alt="" class="h-8 w-8 object-cover rounded-full">
        </div>
  ...
  methods: {
    ...
    addComment() {
      const userComment = {
        ...
        follow_up_id: this.commets.user.id
      }
      const editCmt = {
          content:this.comment,
      }
