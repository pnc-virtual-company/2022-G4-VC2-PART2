<template>
    <div class="container mt-16 flex justify-between">
        <!-- __TITLE CARD show leftBar__ -->
        <div class="leftBar w-3/12 h-screen shadow-md bg-[#cbdae5]">
            <!--____ CARD TITLE___ -->
            <div class="py-5 shadow-md w-full bg-blue-100 text-center">
                <div class="text-lg font-bold text-slate-700">Story Follow Up</div>
            </div>
            <!-- _____CARD BODY______-->
            <div class="shadow-md w-full bg-white px-2 py-1 m-1 box" v-for="i of 4" :key="i">
        ...
        <div class="rightBar w-9/12 h-screen bg-[#DDE8F0] flex justify-center items-end">
            <div class="w-full">
