          ...
          <div class="flex flex-col w-4/12 border-r-2 overflow-y-auto">
            ...
            <div class="w-full ">
              ...
              <div class="group inline-block w-full text-center  ">
                <button class="w-full outline-none focus:outline-none border px-3 py-4 rounded-sm flex items-center min-w-32 hover:bg-[#6267f6] h-14"  style="background-color: #DDE8F0;" @click="isTrue = !isTrue">
                  <span v-if="commets =='' " class="pr-1 font-semibold flex-1">User Name</span>
                  <span v-else class="pr-1 font-semibold flex-1">{{commets.user.first_name}} {{commets.user.last_name}}</span>
